...
exports.init = function (filteringDomains, targetIP, listen, debugFlag, callback) {
  var that = this;
...
exports.start = function (callback, listen) {
  var that = this;
